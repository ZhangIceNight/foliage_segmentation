...
from .dhmamba_voxel import DHMamba_voxel
from torch.optim.lr_scheduler import LinearLR, CosineAnnealingLR, SequentialLR

class DHMamba_voxel_pl(pl.LightningModule):
    def __init__(self, config):
        super().__init__()
        self.model_hparams = config.model
        self.opt_hparams = config.optimizer
        self.model = DHMamba_voxel(num_classes=int(self.model_hparams['num_classes']), HGNeighbors=int(self.model_hparams['HGNeighbors']))
