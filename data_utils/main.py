...
if __name__ == "__main__":
    ...
    dataset_paths = {
        "Tropical": "./Tropical/tiles",
        "MixedForest": "./MixedForest/tiles",
        "ForestSemantic_Simple": "./ForestSemantic_Simple/Plot_1.las",
        "Birch": "./Birch/reference_pc_White_Birch.npy",
        "Larch": "./Larch/reference_pc_Dahurian_Larch.npy",
        "Chinese_scholar_tree": "./Chinese_scholar_tree/reference_pc_Chinese_scholar_tree.npy",
        "Evo": "./Evo/plot_a.ply",
        "ForestSemantic_Difficult": "./ForestSemantic_Difficult/Plot_5.las",
    }

    dataset_output_dirs = {
        "Tropical": "./Tropical/tiles",
        "MixedForest": "./MixedForest/tiles",
        "ForestSemantic_Simple": "./ForestSemantic_Simple/tiles",
        "Birch": "./Birch/tiles",
        "Larch": "./Larch/tiles",
        "Chinese_scholar_tree": "./Chinese_scholar_tree/tiles",
        "Evo": "./Evo/tiles",
        "ForestSemantic_Difficult": "./ForestSemantic_Difficult/tiles",
    }
